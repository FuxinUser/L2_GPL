 ...
 * Author: ICSC余士鵬
 * Date: 2019/10/29
 * Description: ZPL 語言封裝類別 (Builder模式)
 * Reference: 
 * Modified: 
 */
namespace LabelPrint.Printer
{
    public class ZplInstructionUtil
    {
        ...
        /** 清空目前組合的 zpl 碼 */
        public ZplInstructionUtil ClrZplCode()
        {
            _zplCode.Clear();
            return this;
        }
        ...
        public ZplInstructionUtil StartZPL()
        {
            _zplCode.Append(START_ZPL);
            return this;
        }
        /** ZPL 區段終止標號 (放在 ZPL 語言結尾) */
        public ZplInstructionUtil EndZPL()
        {
        ...
        * @return
        */
        public ZplInstructionUtil SelectEncoding(string deviceAndCodename)
        {
         ...
         * @return
         */
        public ZplInstructionUtil ChgEncoding(int encodingCode)
        {
        ...
        /**
             ...
             * @return
             */
        public ZplInstructionUtil FontIdentifier(string fontLetter, string deviceAndFontname)
        {
         ...
         * @return
         */
        public ZplInstructionUtil ChangeAlphanumericFont(string fontLetter, int width, int height)
        {
         ...
         * @return
         */
        public ZplInstructionUtil UseFontN(string fontLetter, int width, int height)
        {
         ...
         * @return
         */
        public ZplInstructionUtil UseFont(string fontLetter, int width, int height)
        {
         ...
         * @return
         */
        public ZplInstructionUtil UseFontByName(string fontName, int width, int height)
        {
        ...
        /**
             ...
             * @return
             */
        public ZplInstructionUtil LabelLength(int y)
        {
         ...
         * @return
         */
        public ZplInstructionUtil LabelHome(int x, int y)
        {
        ...
        /**
             ...
             * gap 字距
             * */
        public ZplInstructionUtil FieldParam(int gap)
        {
        ...
        /**
             ...
             * */
        public ZplInstructionUtil FieldOrigin(int x, int y, int align)
        {
        ...
        /**
             ...
             * align 0: left ,  1: right,  2: auto
             * */
        public ZplInstructionUtil FieldType(int x, int y, int align)
        {
        ...
        /**
             ...
             * */
        public ZplInstructionUtil FieldBlock(string align)
        {
        ...
        /**
             ...
             * data:  要印出的資料
             * */
        public ZplInstructionUtil FieldData(string data)
        {
        ...
        /**
             * Field Separator (換行)
             * */
        public ZplInstructionUtil FieldSeparator()
        {
         ...
         * @return
         */
        public ZplInstructionUtil FieldOrientation(string rotation)
        {
        ...
        * @return
        */
        public ZplInstructionUtil BarCode128(int start_x, int start_y, int height, string code)
        {
            _zplCode.Append(string.Format(_format, "^FO{0},{1},2^BCN,{2},N,N,N^FD{3}^FS", start_x, start_y, height, code));
            return this;
        }
        /**  印出  BarCode 39 (包含換行) */
        public ZplInstructionUtil BarCode39(int start_x, int start_y, int height, string code)
        {
         ...
         * @return
         */
        public ZplInstructionUtil QrCode(int start_x, int start_y, int size, string code)
        {
        ...
        public ZplInstructionUtil Text(string EnText, string ZebraFont, int px, int py, string Orient, int Height, int Width)
        {
         ...
         * @return
         */
        public ZplInstructionUtil GraphicBox(int width, int height, int border, int degree)
        {
